...
public class Project{
    public static void main(String[]args){
        ...
        System.out.printf("%-8s%-12s%-18s%-18s%s%n","Emp No","Emp Name","Department","Designation","Salary");
        System.out.printf("%-8d%-12s%-18s%-18s%d%n",empNo[index],empName[index],department[index],designation,salary);
    }
}